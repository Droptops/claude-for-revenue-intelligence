...
WORKFLOW_POLICIES: dict[str, WorkflowPolicy] = {
    ...
    "signature_authority_extraction": WorkflowPolicy(
        workflow="signature_authority_extraction",
        min_reasoning_rank=2,
        max_relative_cost=3,
        latency_preference="MEDIUM",
        default_output_tokens=1_400,
        cacheable_context=True,
        escalation_triggers=("ambiguous signature block", "multiple counterparties", "contested authority"),
    ),
}
...
def _demo() -> None:
    demos = [
        ...
        ("signature_authority_extraction", 18_000, False, False),
    ]
